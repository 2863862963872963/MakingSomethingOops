...
function Library:SetAutoSave(Enabled: boolean, Filename: string?)
    ...
    if Library.AutoSaveConnection then
        Library.AutoSaveConnection:Disconnect()
        Library.AutoSaveConnection = nil
    end

    if not Enabled then return end

    -- Patch all existing toggle/option callbacks
    local function HookSave()
    ...
    -- We use a BindableEvent as a lightweight debounce bus
