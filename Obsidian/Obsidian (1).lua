...
local Library = {
    ...
    TweenInfo = TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), -- MOD: smoother 0.15s
    NotifyTweenInfo = TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), -- MOD: 0.3s notify
    ...
    DPIScale = 1,
    CornerRadius = 6, -- MOD: rounder corners

    IsLightTheme = false,
    Scheme = {
        -- MOD: Cyberpunk dark teal theme
        BackgroundColor = Color3.fromRGB(10, 12, 18),       -- deep navy-black
        MainColor = Color3.fromRGB(18, 20, 30),             -- dark blue-grey panels
        AccentColor = Color3.fromRGB(0, 210, 180),          -- teal/cyan accent
        OutlineColor = Color3.fromRGB(38, 42, 62),          -- subtle blue-tinted border
        FontColor = Color3.fromRGB(220, 230, 245),          -- soft cool white text
        Font = Font.fromEnum(Enum.Font.Code),

        RedColor = Color3.fromRGB(255, 65, 65),
...
local Templates = {
    ...
    Window = {
        ...
        Size = UDim2.fromOffset(760, 620), -- MOD: larger default window
        ...
        GlobalSearch = false,
        CornerRadius = 6, -- MOD: matches Library.CornerRadius
        NotifySide = "Right",
        ShowCustomCursor = true,
        Font = Enum.Font.Code,
        ToggleKeybind = Enum.KeyCode.RightControl,
...
function Library:AddOutline(Frame: GuiObject)
    local OutlineStroke = New("UIStroke", {
        Color = "OutlineColor",
        Thickness = 1.25, -- MOD: slightly thicker for definition
        ZIndex = 2,
        Parent = Frame,
    })
    local ShadowStroke = New("UIStroke", {
        Color = "DarkColor",
        Thickness = 2, -- MOD: deeper shadow
        ZIndex = 1,
        Parent = Frame,
    })
...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        function Toggle:Display()
            ...
            -- MOD: ball color shifts to a lighter tone when toggle is ON for contrast
            local BallColor = Toggle.Value
            ...
            Library.Registry[Ball].BackgroundColor3 = Toggle.Value and "WhiteColor" or "FontColor"
        end
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        -- MOD: rounded left edge on slider fill
        New("UICorner", {
...
function Library:Notify(...)
    ...
    New("UIPadding", {
        ...
        PaddingLeft = UDim.new(0, 14), -- MOD: extra left padding to make room for accent stripe
        PaddingRight = UDim.new(0, 8),
    ...
    -- MOD: Accent left stripe on notification
    do
        local NotifStripe = New("Frame", {
            AnchorPoint = Vector2.new(0, 0.5),
            BackgroundColor3 = "AccentColor",
            Position = UDim2.fromScale(0, 0.5),
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        WindowTitle = New("TextLabel", {
            ...
            TextSize = 20,
            TextColor3 = "AccentColor", -- MOD: accent-colored title text
            Parent = TitleHolder,
        })
    ...
    function Window:AddTab(...)
        ...
        do
            ...
            -- MOD: Accent left-border indicator bar (hidden, shown when tab is active)
            do
        ...
        function Tab:AddGroupbox(Info)
            ...
            do
                ...
                -- MOD: Accent-tinted header background strip
                local HeaderTint = New("Frame", {
                    BackgroundColor3 = "AccentColor",
                ...
                if BoxIcon then
                    -- MOD: icon rendered with accent glow color always
                    New("ImageLabel", {
                        Image = BoxIcon.Url,
                ...
                GroupboxLabel = New("TextLabel", {
                    ...
                    Size = UDim2.new(1, BoxIcon and -52 or -36, 0, 34),
                    Text = Info.Name,
                    TextSize = 15,
                    TextXAlignment = Enum.TextXAlignment.Left,
                    Parent = GroupboxHolder,
                ...
                -- MOD: Collapse chevron button on the right of the header
                ...
                local CollapseChevron = New("ImageLabel", {
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    BackgroundTransparency = 1,
                    Image = CollapseIcon and CollapseIcon.Url or "",
                    ImageColor3 = "AccentColor",
                    ImageRectOffset = CollapseIcon and CollapseIcon.ImageRectOffset or Vector2.zero,
                    ImageRectSize = CollapseIcon and CollapseIcon.ImageRectSize or Vector2.zero,
                    Position = UDim2.fromScale(0.5, 0.5),
                    Size = UDim2.fromOffset(14, 14),
                    Parent = CollapseBtn,
                })

                -- Make the entire header clickable (transparent button overlay)
                ...
                -- MOD: Collapse / expand logic
                local SectionCollapsed = false
                local function ToggleCollapse()
                    SectionCollapsed = not SectionCollapsed
                    GroupboxContainer.Visible = not SectionCollapsed
                    -- Chevron rotation tween: 180° when collapsed, 0° when expanded
                    local rotation = SectionCollapsed and 180 or 0
                    TweenService:Create(CollapseChevron, Library.TweenInfo, {
                        Rotation = rotation,
                    }):Play()
                    -- Resize the holder to just the header when collapsed
                ...
                HeaderBtn.MouseEnter:Connect(function()
                    TweenService:Create(HeaderTint, Library.TweenInfo, {
            ...
            function Groupbox:Resize()
                if not GroupboxContainer.Visible then return end -- MOD: skip resize when collapsed
                GroupboxHolder.Size = UDim2.new(1, 0, 0, (GroupboxList.AbsoluteContentSize.Y / Library.DPIScale) + 49)
            end
        ...
        function Tab:Show()
            ...
            -- MOD: show accent left bar
            if TabButton:FindFirstChild("_AccentBar") then
                TweenService:Create(TabButton._AccentBar, Library.TweenInfo, {
                    BackgroundTransparency = 0,
                }):Play()
            end
